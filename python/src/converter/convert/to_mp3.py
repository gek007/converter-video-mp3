...
if __name__ == "__main__":
    ...
    print("Starting to_mp3.py")
    print("os.getenv('MP3_QUEUE'):", os.getenv("MP3_QUEUE"))
    print("os.getenv('VIDEO_QUEUE'):", os.getenv("VIDEO_QUEUE"))
    print("os.getenv('RABBITMQ_HOST'):", os.getenv("RABBITMQ_HOST"))
    print("os.getenv('RABBITMQ_USER'):", os.getenv("RABBITMQ_USER"))
    print("os.getenv('RABBITMQ_PASS'):", os.getenv("RABBITMQ_PASS"))
    print("os.getenv('RABBITMQ_PORT'):", os.getenv("RABBITMQ_PORT"))
    print("os.getenv('MONGO_URI'):", os.getenv("MONGO_URI"))
    print("os.getenv('MONGO_URI_LOCAL'):", os.getenv("MONGO_URI_LOCAL"))
    print("os.getenv('MONGO_URI_LOCAL'):", os.getenv("MONGO_URI_LOCAL"))
